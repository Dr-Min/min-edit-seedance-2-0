...
涵盖输入约束、@ 引用语法、运镜语言、提示词结构模式，以及广告、短剧、MV、科普教育等场景的现成模版。此版本还增加了 Higgsfield MCP 媒体角色与提交规则。

## 安装

### 方式 A：通过 skills CLI（推荐）
...
基于 MIT 许可证下的 [dexhunter/seedance2-skill](https://github.com/dexhunter/seedance2-skill) 修改。本版本增加了 Higgsfield MCP 集成说明，并保留原版权声明。
